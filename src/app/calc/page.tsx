...
const pageCalc = () => {
  ...
  const handleClickType = e =>{
    const typeItems =
      typesRef.current?.children;
    if (typeItems) {
      Array.from(typeItems).forEach(
        child => {
          child.classList.remove(
            styles.options__types__item__active
          );
        }
      );
    }
        ...
        <div className='container'>
          ...
          >
            ...
            >
              <div
                className={
                  styles.window__content
                }
              >
                <div
                  className={
                    styles.window__canvas
                  }
                >
                  <img
                    className={
                      styles.window__canvas__window
                    }
                    src={
                      windows.window1_gl
                        .src
