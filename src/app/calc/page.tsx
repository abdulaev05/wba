...
const pageCalc = () => {
  const width = useInput("1300");
  const height = useInput("1500");
  ...
  const handleClickType = (e: any) => {
    ...
    if (typeItems) {
      Array.from(typeItems).forEach(child => {
        child.classList.remove(styles.options__types__item__active);
      });
    }
            ...
            <div className={styles.window}>
              <div className={styles.window__content}>
                <div className={styles.window__canvas}>
                  <img
                    className={styles.window__canvas__window}
                    src={windows.window1_gl.src}
                    alt=''
                  />
            ...
            <div className={styles.options}>
              <div className={styles.options__content}>
                <div className={styles.options__container}>
                  ...
                  <div ref={typesRef} className={styles.options__types}>
                    <div
                      className={`${styles.options__types__item} ${styles.options__types__item__active}`}
                    ...
                    <div
                      className={styles.options__types__item}
                      onClick={handleClickType}
                    >
                      <svg
                        viewBox='0 0 60 60'
                ...
                <div className={styles.options__container}>
                  ...
                  <div className={styles.options__window_options}>
                    <div className={styles.options__window_options__size}>
                      <div
                        className={styles.options__window_options__size__item}
                      >
                        <p className={styles.options__title2}>Ширина, мм</p>
                        <input
                          className={inputs.square_input}
                          type='number'
                          name='width'
                          {...width}
                        />
