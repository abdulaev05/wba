  ...
  return (
    <div className={styles.icon} style={{ width: size, height: size }}>
      <svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" style={{ fill: 'currentColor' }}>
        <path d="m56.74 71a27.42 27.42 0 0 1 -10.37-2.54c-7.53-3.2-15.97-9.06-23.77-16.46s-14.04-15.66-17.6-23c-3.67-7.7-4-13.7-.91-16.93l7.4-7.75c2-2.13 5.75-1.89 8.29.54l11.22 10.7a7 7 0 0 1 2.16 4.13 4.88 4.88 0 0 1 -1.25 4.12l-5.64 5.91c-1.2 1.26.62 6.36 6.31 11.8a27.62 27.62 0 0 0 7.76 5.41c2 .86 3.7 1 4.32.36l5.65-5.91c2-2.13 5.75-1.89 8.28.53l11.2 10.7a7.09 7.09 0 0 1 2.17 4.13 4.91 4.91 0 0 1 -1.25 4.12l-7.4 7.75a8.69 8.69 0 0 1 -6.57 2.39zm-41.68-66.14a2.89 2.89 0 0 0 -2.13.84l-7.39 7.75c-2.44 2.55-1.97 7.89 1.28 14.65 3.44 7.16 9.54 15.11 17.18 22.4s15.86 13 23.17 16.12c6.9 2.94 12.26 3.16 14.69.61l7.41-7.75a3 3 0 0 0 .73-2.48 5.06 5.06 0 0 0 -1.57-2.94l-11.2-10.7c-1.74-1.66-4.19-1.93-5.46-.6l-5.65 5.91c-1.27 1.32-3.59 1.35-6.55.1a29.56 29.56 0 0 1 -8.39-5.77c-5.18-5-9.18-11.76-6.38-14.66l5.65-5.91a3 3 0 0 0 .71-2.49 5 5 0 0 0 -1.57-2.94l-11.2-10.7a4.93 4.93 0 0 0 -3.33-1.44z" />
        <path d="m67.64 63.61a1 1 0 0 1 -.69-.28l-18.95-18.1a1 1 0 0 1 1.38-1.45l19 18.11a1 1 0 0 1 0 1.41 1 1 0 0 1 -.74.31z" />
        <path d="m28.84 26.55a1 1 0 0 1 -.69-.27l-18.96-18.11a1 1 0 0 1 1.38-1.45l19 18.11a1 1 0 0 1 0 1.41 1 1 0 0 1 -.73.31z" />
      </svg>
    </div>
  );
};
